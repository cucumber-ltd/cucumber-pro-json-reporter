...
import static io.cucumber.pro.Keys.CUCUMBER_PRO_PROJECT_NAME;
...
public class ProjectName {
    ...
    public String getProjectName() {
        ...
        throw new CucumberException("Couldn't detect project name. Please define " + CUCUMBER_PRO_PROJECT_NAME);
    }
}
