...
* The plugin no longer tries to guess project name from the CI environment. It *has* to be defined explicitly
  in `cucumberpro.projectname` (YAML) or `CUCUMBERPRO_PROJECTNAME` (Environment variable)
